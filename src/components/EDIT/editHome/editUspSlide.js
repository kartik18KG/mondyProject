...
import "./css/editUspSlide.css";
import { Row, Col, Form, Button } from "react-bootstrap";
import { EditUspSlideFunction } from "../../crudFunctions/homePageFunctions";
import { HomeContext } from "../../../contexts/homeContext";

const EditUspSlide = ({ content }) => {
  const [EditUspData, setUspData] = useState([
    { heading: "", content: "" },
    { heading: "", content: "" },
    { heading: "", content: "" },
  ]);
    ...
    <div className="container bg-light">
      <Form onSubmit={handledSubmit}>
        <div className="usp-heading">
          <h1>
            {" "}
            <b className="text-danger">EDIT</b> What makes us special
          </h1>
        </div>
        <div className="usp">
          <Row>
