    ...
    !(function (e) {
      ...
      26: function (e, t, n) {
        ...
        (t.PLAYER_BRIDGE_API = Object.freeze({ UPDATE_STATE: "updateState" })),
          (t.PLAYER_BRIDGE_MESSAGE_NAMESPACE =
            "twitch-everywhere-player-bridge");
      },
      29: function (e, t, n) {
        "use strict";
        function r(e, t) {
        ...
        function s(e, t) {
          if (!e)
            throw new f.MissingParameterError(
              "An element argument is required"
            );
          if (!u(e) && !a(e))
            throw new f.MissingParameterError(
    ...
    return (
      <div className="live-stream-container">
        <div className="live-stream-heading">
          <h2>Welcome to the Live Session</h2>
        </div>
        ...
        <div className="stream-instructions">
          <ul>
            <li>This stream is powered by Twitch </li>
            <li>
              {" "}
              In order to comment in the LiveStream you need to be logged in to
              your twitch account
            </li>
            <li>You are requested to stay respectful in the chat</li>
            <li>
              Owner deserves the right to boot any offensive participant from
              the chat
            </li>
          </ul>
        </div>
